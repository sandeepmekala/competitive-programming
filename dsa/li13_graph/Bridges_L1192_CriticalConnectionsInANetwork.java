...
public class Bridges_L1192_CriticalConnectionsInANetwork {
    public static void main (String[] args) {
        ...
        cons.add(Arrays.asList(0, 1));      // 0 --> 1 and 1 --> 0
        ...
        List<List<Integer>> bridges = obj.criticalConnections(n, cons);
    ...
    // Insertion time is when dfs starts, low time is the lowest time of all the neighbors except parent.
    ...
    private void dfs(int node, int parent, List<List<Integer>> adj, int[] vis, int tin[], int low[],
