...
public class Hashtable {
	...
	public static void main(String[] args) {
		...
		// -> open addressing: keep looking the hashtable until an empty slot if found
		//		-> for delete mark deleted nodes are deleted so that search won't fail
		//		-> next slot can be found using these methods:
		//			-> 1. linear probing: search next slot linearly (hash(x)+1)%size
		//				-> good cache performance and clustering problem
		//				-> problems: 
