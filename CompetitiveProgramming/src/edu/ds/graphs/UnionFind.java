...
public class UnionFind {
	...
	// path compression: when path is long like linked list, when it find the parent of lowest leaf node, it sets the same as parent to all the above parent nodes in the while recursion exit
