...
public class Algo061_LongestPolindromicSubsequence {

	public static void main(String[] args) {
		Algo061_LongestPolindromicSubsequence obj = new Algo061_LongestPolindromicSubsequence();
		String text = "agbdba";
		int n = text.length();
	...
	/*	
	 * concept: start with l=1 and go till l=n.
