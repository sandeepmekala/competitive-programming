...
public class Bst_1008_ConstructBinarySearchTreefromPreorderTraversal {
    public static void main(String[] args) {
        Bst_1008_ConstructBinarySearchTreefromPreorderTraversal obj = new Bst_1008_ConstructBinarySearchTreefromPreorderTraversal();
