...
public class Scc_A15_StronglyConnectedComponents_KosarajuAlgo {

	public static void main(String[] args) {
		Scc_A15_StronglyConnectedComponents_KosarajuAlgo obj = new Scc_A15_StronglyConnectedComponents_KosarajuAlgo();
	...
	public List<HashSet<Integer>> getStronglyConnectedComponents(GraphAdjLst g) {
		...
		while(!resStack.isEmpty()) {
			...
			if(!visited.contains(current)) {
				dfs2(g, current, set, visited); // dfs and populate the component set.
				components.add(set);
			}
