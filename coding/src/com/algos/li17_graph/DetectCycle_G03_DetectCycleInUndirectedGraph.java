...
public class DetectCycle_G03_DetectCycleInUndirectedGraph {

	UnionFind_G01_UnionFind uf = new UnionFind_G01_UnionFind();
	...
	public static void main(String[] args) {
		...
		// | /
		// 2
		DetectCycle_G03_DetectCycleInUndirectedGraph obj = new DetectCycle_G03_DetectCycleInUndirectedGraph();
