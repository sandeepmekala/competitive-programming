...
public class ShortestPath_G01_ShortestPathInUndirectedGraph {

	public static void main(String[] args) {
		ShortestPath_G01_ShortestPathInUndirectedGraph obj = new ShortestPath_G01_ShortestPathInUndirectedGraph();
