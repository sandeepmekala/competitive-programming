...
public class _L23_MergeKSortedLists {

	public static void main(String[] args) {
		_L23_MergeKSortedLists obj = new _L23_MergeKSortedLists();
		
		ListNode[] lists = new ListNode[3];
		_G01_SingleLinkedList l1 = new _G01_SingleLinkedList();
		l1.insertAtEnd(1);
		l1.insertAtEnd(4);
		l1.insertAtEnd(5);
		lists[0] = l1.head;
		
		_G01_SingleLinkedList l2 = new _G01_SingleLinkedList();
		l2.insertAtEnd(1);
		l2.insertAtEnd(3);
		l2.insertAtEnd(4);
		lists[1] = l2.head;
		
		_G01_SingleLinkedList l3 = new _G01_SingleLinkedList();
		l3.insertAtEnd(2);
		l3.insertAtEnd(6);
		lists[2] = l3.head;
