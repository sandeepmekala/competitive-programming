...
public class Partitions_L1043_PartitionArrayForMaximumSum {
    public static void main(String[] args) {
        Partitions_L1043_PartitionArrayForMaximumSum obj = new Partitions_L1043_PartitionArrayForMaximumSum();
