...
public class _Stocks_L122_BestTimeToBuyAndSellStockII {

	public static void main(String[] args) {
		_Stocks_L122_BestTimeToBuyAndSellStockII obj = new _Stocks_L122_BestTimeToBuyAndSellStockII();
	...
	public int maxProfit(int[] prices, int ind, int isBuy) {	// buy = 1 means, allowed to buy
		int n = prices.length;
		if (ind == n)
		...
		if (isBuy == 1) {
			...
			int sell = prices[ind] + maxProfit(prices, ind + 1, 1);
