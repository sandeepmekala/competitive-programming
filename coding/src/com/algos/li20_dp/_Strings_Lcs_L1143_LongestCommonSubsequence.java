...
public class _Strings_Lcs_L1143_LongestCommonSubsequence {
	
	public static void main(String[] args) {
		_Strings_Lcs_L1143_LongestCommonSubsequence obj = new _Strings_Lcs_L1143_LongestCommonSubsequence();
