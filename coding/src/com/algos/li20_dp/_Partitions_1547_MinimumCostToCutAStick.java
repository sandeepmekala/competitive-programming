...
public class _Partitions_1547_MinimumCostToCutAStick {
    public static void main(String[] args) {
        _Partitions_1547_MinimumCostToCutAStick obj = new _Partitions_1547_MinimumCostToCutAStick();
    ...
    public int minCost2(int n, int[] cuts) {
        ...
        return minCost(1, c, cutsTemp);
    }

    private int minCost(int i, int j, int[] cuts) {
        if(j<i)
            return 0;
        ...
        for(int k=i; k<=j; k++){
            ...
            minCost(i, k-1, cuts) + minCost(k+1, j, cuts);
