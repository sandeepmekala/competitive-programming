...
public class Squares_L1277_CountSquareSubmatricesWithAllOnes {
    public static void main(String[] args) {
        Squares_L1277_CountSquareSubmatricesWithAllOnes obj = new Squares_L1277_CountSquareSubmatricesWithAllOnes();
