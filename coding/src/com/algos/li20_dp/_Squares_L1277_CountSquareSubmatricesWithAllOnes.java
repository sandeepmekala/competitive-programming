...
public class _Squares_L1277_CountSquareSubmatricesWithAllOnes {
    public static void main(String[] args) {
        _Squares_L1277_CountSquareSubmatricesWithAllOnes obj = new _Squares_L1277_CountSquareSubmatricesWithAllOnes();
