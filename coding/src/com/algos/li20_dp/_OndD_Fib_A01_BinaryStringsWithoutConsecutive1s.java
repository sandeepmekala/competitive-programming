...
public class _OndD_Fib_A01_BinaryStringsWithoutConsecutive1s {

	public static void main(String[] args) {
		_OndD_Fib_A01_BinaryStringsWithoutConsecutive1s obj = new _OndD_Fib_A01_BinaryStringsWithoutConsecutive1s();
