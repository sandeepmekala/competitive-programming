...
public class Subsequence_A04_CountPartitionsWithGivenDifference {
    public static void main(String[] args) {
        Subsequence_A04_CountPartitionsWithGivenDifference obj = new Subsequence_A04_CountPartitionsWithGivenDifference();
