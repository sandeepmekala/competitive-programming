...
public class _Stocks_L714_BestTimeToBuyAndSellStockWithTransactionFee {

	public static void main(String[] args) {
		_Stocks_L714_BestTimeToBuyAndSellStockWithTransactionFee obj = new _Stocks_L714_BestTimeToBuyAndSellStockWithTransactionFee();
