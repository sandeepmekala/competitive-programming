...
public class Matrix_L74_SearchA2DMatrix {
    ...
    // 2. each row and columns are in increasing order and first element of next row is greater then last element of curr row.
    // Boelow algo is best for 1st case. Use linear search from top-right corner.
