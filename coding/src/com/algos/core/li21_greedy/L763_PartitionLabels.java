package  com.algos.core.li21_greedy;
...
public class L763_PartitionLabels {
	 ...
	 * Idea: Go greed, have the last indices of each char.
	 ...
	 * If our current char pointer reaches our lastInd pointer, if means we have traveled all the chars in that partition and lastInd is the max last index of any char in that partion.
