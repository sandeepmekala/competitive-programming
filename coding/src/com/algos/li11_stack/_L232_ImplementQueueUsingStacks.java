...
public class _L232_ImplementQueueUsingStacks {

	public static void main(String[] args) {
		_L232_ImplementQueueUsingStacks obj = new _L232_ImplementQueueUsingStacks();
    ...
    public _L232_ImplementQueueUsingStacks() {
        stack1 = new Stack<>();
        stack2 = new Stack<>();
    }
