...
public class _L295_FindMedianFromDataStream {

	public static void main(String[] args) {
		_L295_FindMedianFromDataStream obj = new _L295_FindMedianFromDataStream();
    ...
    public _L295_FindMedianFromDataStream() {
    ...
    public void addNum(int num) {
        ...
        if(maxq.size() > 0 && minq.size() > 0){     
            while(maxq.peek()>minq.peek()){   //swap the elements to keep both q's elements in sync
                minq.add(maxq.remove());
