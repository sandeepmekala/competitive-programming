...
// Modern Java 21 Records instead of classes
...
record Foo(String name, List<Bar> bars) {
	// Compact constructor for initialization
...
// Sealed classes for better type safety (Java 17+)
sealed interface NestedStructure permits Outer {}

record Outer(Nested nested) implements NestedStructure {}
