...
public class _AllPairShartedPath_L1334_FindTheCityWithTheSmallestNumberOfNeighborsAtAThresholdDistance {
    public static void main(String[] args) {
        _AllPairShartedPath_L1334_FindTheCityWithTheSmallestNumberOfNeighborsAtAThresholdDistance obj = new _AllPairShartedPath_L1334_FindTheCityWithTheSmallestNumberOfNeighborsAtAThresholdDistance();
