...
public class _Subsequence_A04_CountPartitionsWithGivenDifference {
    public static void main(String[] args) {
        _Subsequence_A04_CountPartitionsWithGivenDifference obj = new _Subsequence_A04_CountPartitionsWithGivenDifference();
