...
public class _Partitions_A05_OptimalCostBinarySearchTree {

	public static void main(String[] args) {
		_Partitions_A05_OptimalCostBinarySearchTree obj = new _Partitions_A05_OptimalCostBinarySearchTree();
