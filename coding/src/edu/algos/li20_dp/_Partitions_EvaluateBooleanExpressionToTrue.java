...
public class _Partitions_EvaluateBooleanExpressionToTrue {
    public static void main(String[] args) {
        _Partitions_EvaluateBooleanExpressionToTrue obj = new _Partitions_EvaluateBooleanExpressionToTrue();
        String exp = "F|T^F";
