...
public class _Strings_Lcs_L1312_MinimumInsertionStepsToMakeAStringPalindrome {
    public static void main(String[] args) {
        _Strings_Lcs_L1312_MinimumInsertionStepsToMakeAStringPalindrome obj = new _Strings_Lcs_L1312_MinimumInsertionStepsToMakeAStringPalindrome();
