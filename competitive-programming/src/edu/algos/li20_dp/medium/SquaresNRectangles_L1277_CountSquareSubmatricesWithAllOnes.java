...
public class SquaresNRectangles_L1277_CountSquareSubmatricesWithAllOnes {
    public static void main(String[] args) {
        SquaresNRectangles_L1277_CountSquareSubmatricesWithAllOnes obj = new SquaresNRectangles_L1277_CountSquareSubmatricesWithAllOnes();
