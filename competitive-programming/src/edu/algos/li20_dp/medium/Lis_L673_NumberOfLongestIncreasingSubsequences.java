...
public class Lis_L673_NumberOfLongestIncreasingSubsequences {
    public static void main(String[] args) {
        Lis_L673_NumberOfLongestIncreasingSubsequences obj = new Lis_L673_NumberOfLongestIncreasingSubsequences();
