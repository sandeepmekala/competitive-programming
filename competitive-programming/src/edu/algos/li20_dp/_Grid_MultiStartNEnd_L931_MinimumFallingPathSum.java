...
public class _Grid_MultiStartNEnd_L931_MinimumFallingPathSum {
    public static void main(String[] args) {
        _Grid_MultiStartNEnd_L931_MinimumFallingPathSum obj = new _Grid_MultiStartNEnd_L931_MinimumFallingPathSum();

        int[][] matrix = new int[][]{{2,1,3},{6,5,4},{7,8,9}};
        System.out.println(obj.minFallingPathSum(matrix));
        System.out.println(obj.minFallingPathSum2(matrix));
    }
