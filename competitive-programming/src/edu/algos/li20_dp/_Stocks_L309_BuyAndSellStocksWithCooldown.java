...
public class _Stocks_L309_BuyAndSellStocksWithCooldown {

	public static void main(String[] args) {
		_Stocks_L309_BuyAndSellStocksWithCooldown obj = new _Stocks_L309_BuyAndSellStocksWithCooldown();
	...
	public int maxProfit(int[] prices, int i, int isBuy) {
		...
		if (isBuy == 1) {
			...
			int sell = prices[i] + maxProfit(prices, i + 2, 1);
