...
public class Dp03ClimbingStairs {

	public static void main(String[] args) {
		Dp03ClimbingStairs obj = new Dp03ClimbingStairs();
		System.out.println(obj.stairchaseBottomUp(3));
		System.out.println(obj.stairchasesXBottomUp(4, new int[] { 1, 3, 5 }));
	}

	// Idea: that nth stair you can reach from n-1 or n-2 stair. So take the number of ways to reach n-1 and n-2 stairs. this recursively goes till base case for n-1 and n-2 cases.
	// time: O(n)
