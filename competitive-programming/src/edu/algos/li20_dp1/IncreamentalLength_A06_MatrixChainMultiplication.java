...
public class IncreamentalLength_A06_MatrixChainMultiplication {

	public static void main(String[] args) {
		IncreamentalLength_A06_MatrixChainMultiplication obj = new IncreamentalLength_A06_MatrixChainMultiplication();
	 ...
	 * 
	 * */
	public int minOperationsCountBottomUp(int[] dimensions) {
		int n = dimensions.length;
		int[][] mem = new int[n][n];
		for(int l=1; l<n; l++) {
			for(int i=1; i<n-l; i++) {
