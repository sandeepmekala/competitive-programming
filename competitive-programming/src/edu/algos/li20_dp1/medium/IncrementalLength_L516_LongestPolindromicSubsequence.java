...
public class IncrementalLength_L516_LongestPolindromicSubsequence {

	public static void main(String[] args) {
		IncrementalLength_L516_LongestPolindromicSubsequence obj = new IncrementalLength_L516_LongestPolindromicSubsequence();
		
		String s = "agbdba";
		int n = s.length();
		
		System.out.println(obj.longestPolindromicSubsequenceTopDown(s, 0, n-1));
