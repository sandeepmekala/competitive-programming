...
public class LoopUntil_L1235_MaximumProfitInJobScheduling {

	public static void main(String[] args) {
		LoopUntil_L1235_MaximumProfitInJobScheduling obj = new LoopUntil_L1235_MaximumProfitInJobScheduling();
