...
import edu.algos.li00.model.HuffmanNode;
...
public class HuffmanCoding {
	...
	// concept: insert the input to min heap so that min retrieval is optimal once the tree is built, take the last 2 mins and create new internal node by
