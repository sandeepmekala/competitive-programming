package edu.algos.li18_graph_grid.hard;

import java.util.PriorityQueue;

public class L778_Dijkstra_SwimInRisingWater {

	public static void main(String[] args) {
		L778_Dijkstra_SwimInRisingWater obj = new L778_Dijkstra_SwimInRisingWater();
