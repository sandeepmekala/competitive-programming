...
public class Dp09RegularExpressionMatching {

	public static void main(String[] args) {
		Dp09RegularExpressionMatching obj = new Dp09RegularExpressionMatching();
	 ...
	 * 		
	 * */
	private boolean match(String text, String pattern, int n, int m) {
