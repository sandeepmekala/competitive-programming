package edu.algos.li19_graph_grid.hard;

import java.util.PriorityQueue;

public class L778_FrontierBfs_SwimInRisingWater {

	public static void main(String[] args) {
		L778_FrontierBfs_SwimInRisingWater obj = new L778_FrontierBfs_SwimInRisingWater();
