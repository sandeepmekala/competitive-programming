...
public class A10_ShortestPathInDirectedGraph {

	A03_TopologicalSorting_KahnsAlgo  topo = new A03_TopologicalSorting_KahnsAlgo();

	public static void main(String[] args) {
		A10_ShortestPathInDirectedGraph obj = new A10_ShortestPathInDirectedGraph();
	...
	public int[] shortestPath(int N,int M, int[][] edges) {
		...
		for(int node=0; node<N; node++) adj.put(node, new ArrayList<>());
		for(int[] edge: edges){
