...
public class A12_ShartestPathBellmanFord {

	public static void main(String[] args) {
		A12_ShartestPathBellmanFord obj = new A12_ShartestPathBellmanFord();
	...
	// Idea: Loop n-1 times and update all edges dest dist
	// Works with negative edges also unlike Dijkstra
	// It won't work if there is cycle of total weight negative
	// With one more additional iteration can detect this negative weight cycle
	// time = O(V*E)
	// space = O(V)
