...
public class L323_Dfs_NumberOfConnectedComponentsInAnUndirectedGraph {

	public static void main(String[] args) {
		L323_Dfs_NumberOfConnectedComponentsInAnUndirectedGraph obj = new L323_Dfs_NumberOfConnectedComponentsInAnUndirectedGraph();
	...
	private boolean dfs(GraphAdjLst g, int src, HashSet<Integer> visited) {
		...
		visited.add(src);
		for(int neigh: g.adjList.get(src)) {
			dfs(g, neigh, visited);
		}
		return true;
	}
