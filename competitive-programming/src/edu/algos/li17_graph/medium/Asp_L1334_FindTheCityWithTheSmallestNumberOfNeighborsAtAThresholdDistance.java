...
public class Asp_L1334_FindTheCityWithTheSmallestNumberOfNeighborsAtAThresholdDistance {
    public static void main(String[] args) {
        Asp_L1334_FindTheCityWithTheSmallestNumberOfNeighborsAtAThresholdDistance obj = new Asp_L1334_FindTheCityWithTheSmallestNumberOfNeighborsAtAThresholdDistance();
