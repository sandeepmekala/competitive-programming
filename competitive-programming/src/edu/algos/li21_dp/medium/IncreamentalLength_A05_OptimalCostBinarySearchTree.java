...
public class IncreamentalLength_A05_OptimalCostBinarySearchTree {

	public static void main(String[] args) {
		IncreamentalLength_A05_OptimalCostBinarySearchTree obj = new IncreamentalLength_A05_OptimalCostBinarySearchTree();
