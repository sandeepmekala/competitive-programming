...
public class Subsequence_A03_CountPartitionsWithGivenDifference {
    public static void main(String[] args) {
        Subsequence_A03_CountPartitionsWithGivenDifference obj = new Subsequence_A03_CountPartitionsWithGivenDifference();
