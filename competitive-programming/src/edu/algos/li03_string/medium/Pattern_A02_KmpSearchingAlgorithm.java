package edu.algos.li03_string.medium;

import java.util.Arrays;

public class Pattern_A02_KmpSearchingAlgorithm {

	public static void main(String[] args) {
		Pattern_A02_KmpSearchingAlgorithm kmps = new Pattern_A02_KmpSearchingAlgorithm();
	...
	// O(n+m) = O(n)
	public void kmpSearch(String input, String pattern) {
		int n = input.length();
